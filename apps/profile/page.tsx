...
export default function ProfilePage() {
  ...
  if (!user) return <div style={{ padding: '24px', color: '#6B7280' }}>Loading...</div>
  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: '#F8F9FA', padding: '24px' }}>
      <div style={{ maxWidth: '900px', margin: '0 auto' }}>
        ...
        {/* Profile Header Card */}
        <div style={{ background: 'linear-gradient(135deg, #6C63FF, #8B5CF6)', borderRadius: '24px', padding: '32px', marginBottom: '24px', color: 'white', position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ position: 'absolute', bottom: '-60px', left: '-20px', width: '160px', height: '160px', borderRadius: '50%', backgroundColor: 'rgba(255,255,255,0.05)' }} />
          ...
          {/* Stats Row */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginTop: '28px', position: 'relative' }}>
            {[
